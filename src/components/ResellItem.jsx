...
const ResellItem = () => {
    ...
    const fetchData = (startDate, endDate, group) => {
        ...
        //     "id": 12,
        //     "group": 1,
        //     "group_name": "Cosmetics",
        //     "local": 28,
        //     "local_name": "جوانکاری رەنج",
        //     "item_name": "سوراوی قەڵەم",
        //     "item_code": "232",
        //     "quantity": 49,
        //     "price": "0.74",
        //     "date": "2022-02-01",
        //     "datetime": "2022-02-01T10:00:42.111255+03:00",
        //     "sell": 53,
        //     "item": 298
        // }
        ...
        items.map((_item) => {
            console.log(_item)
            _item.ReSell_item.map((sale) => console.log(sale))
            let item_sell = _item.ReSell_item.filter((sale) => (new Date(sale.date) - startDate) >= 0 && (new Date(sale.date) - endDate <= 0))
